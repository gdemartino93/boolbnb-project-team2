...
import { faBars, faHome, faUser, faUserSecret, faFilter, faBed, faCheck, faEye } from '@fortawesome/free-solid-svg-icons'

// import { faBars, faHome, faUser, faUserSecret, faPlus, faBed, faEyeSlash } from '@fortawesome/free-solid-svg-icons'


/* add icons to the library */
library.add(faUserSecret,faUser,faBars,faHome, faFilter, faBed, faCheck,faEye)
