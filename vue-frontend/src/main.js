...
import { faBars, faHome, faUser, faUserSecret, faPlus, faBed, faCheck, faMessage } from '@fortawesome/free-solid-svg-icons'

// import { faBars, faHome, faUser, faUserSecret, faPlus, faBed, faEyeSlash } from '@fortawesome/free-solid-svg-icons'


/* add icons to the library */
library.add(faUserSecret,faUser,faBars,faHome, faPlus, faBed, faCheck, faMessage)
