...
import { faHome, faBed, faBath, faRuler, faLocationDot, faBars, faUser, faUserSecret, faFilter, faCheck, faEye } from '@fortawesome/free-solid-svg-icons'

// import { faBars, faHome, faUser, faUserSecret, faPlus, faBed, faEyeSlash } from '@fortawesome/free-solid-svg-icons'


/* add icons to the library */
library.add(faHome, faBed, faBath, faRuler, faLocationDot, faBars, faUser, faUserSecret, faFilter, faCheck, faEye)
